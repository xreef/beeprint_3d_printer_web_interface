...
export default function fitDimensionsBox (WrappedComponent) {
  class ResponsiveComponent extends Component {
    ...
    getDimensions (el, checkSibling, size) {
      let {
        minWidth = 100,
        minHeight = 100,
        ratio,
      ...
      ReactDOM.findDOMNode(el.current || el).style = 'height: 100px;';
      // el.height = "100px";
    ...
    componentDidMount () {
      ...
      if (this.node) {
        const dimensions = this.getDimensions(this.node, checkSibling, this.size);
    ...
    handleWindowResize (size) {
      ...
      if (node) { this.setState(this.getDimensions(node, checkSibling, this.size)); };
    }
