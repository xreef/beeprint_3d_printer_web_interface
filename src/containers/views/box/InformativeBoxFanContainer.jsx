...
import InformativeFanRealtimeBox from '../../../layouts/box/informativeBox/InformativeFanRealtimeBox'
...
export default connect(mapStateToProps, mapDispatchToProps)(InformativeFanRealtimeBox);
